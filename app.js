...
function showSagePopup() {
    ...
    overlay.innerHTML = `
        <div class="w-[85%] max-w-[320px] bg-white border-4 border-yellow-500 rounded-[40px] p-8 text-center shadow-2xl">
...
function renderGame() {
    ...
    if (activeGame.currentRound > 0) {
        ...
        prevRoundInfoHtml = `<div class="animate-fadeIn">
    ...
    if (roundNum >= 2) {
        if (sageGlobalStatus) {
            sageSectionHtml = `<div class="mb-6 p-6 bg-yellow-500/10 border-2 border-yellow-500/30 rounded-3xl flex items-center justify-center animate-fadeIn">
            ...
            sageSectionHtml = `<div id="sage-container" class="mb-6 p-4 bg-black/5 rounded-3xl border border-[var(--border-ui)] animate-fadeIn">
    ...
    app.innerHTML = `
        <div class="scroll-area" id="game-scroll">
            ...
            <div class="p-4 pb-8">${prevRoundInfoHtml}${sageSectionHtml}<div class="section-title animate-fadeIn" style="animation-delay: 0.1s"><h3>Dice Calculators</h3></div>
